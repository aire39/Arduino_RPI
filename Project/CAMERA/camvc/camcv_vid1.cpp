...
#include "/home/sean/Source/libfacerec-0.04/include/facerec.hpp"	//<-- to modify
...
////////////////////////////////
	...
	{       
		...
		putText(gray, box_text, Point(pos_x, pos_y), FONT_HERSHEY_PLAIN, 1.0, CV_RGB(255,0,0), 1.0);	
